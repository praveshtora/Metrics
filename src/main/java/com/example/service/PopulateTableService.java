...
public class PopulateTableService {
    ...
    public DataServicePOJO getDataServicePOJO(){
        ...
        IA iaDomain= iaDAO.findOne((long)3);
        ICAP icapDomain=icapDAO.findOne((long)2);
        ThreePA threeDomain=threePADAO.findOne((long)4);
        Attrition attrition = attritionDAO.findOne((long)5);
